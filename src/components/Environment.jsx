...
const environmentImgs = [
  {
    imgData: [
      ...
      { img: hull_render1, txtHdng: "Wärtsilä 32 marine engine Render_1", txtDesc: "" },
      { img: hull_render2, txtHdng: "Wärtsilä 32 marine engine Render_2", txtDesc: "" },
      { img: hull_render3, txtHdng: "Wärtsilä 32 marine engine Render_3", txtDesc: "" },
      { img: hull_render4, txtHdng: "Wärtsilä 32 marine engine Render_4", txtDesc: "" },
      { img: hull_render5, txtHdng: "Wärtsilä 32 marine engine Render_5", txtDesc: "" },
      { img: hull_render6, txtHdng: "Wärtsilä 32 marine engine Render_6", txtDesc: "" },
      { img: hull_render7, txtHdng: "Wärtsilä 32 marine engine Render_7", txtDesc: "" },
      { img: hull_render8, txtHdng: "Wärtsilä 32 marine engine Render_8", txtDesc: "" },
      { img: hull_render9, txtHdng: "Wärtsilä 32 marine engine Render_9", txtDesc: "" },
    ],
    coverPic: e6,
    path: "/img",
    titleTxt: "Hull & Wärtsilä 32 marine engine",
